# --- GitHub Actions OIDC provider (no long-lived AWS keys anywhere) ---
...
locals {
  # OIDC subjects scope WHICH workflow context may assume each role.
...
# Shared trust-policy builder: only this repo, only the given workflow context.
